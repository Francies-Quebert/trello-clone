...
export default function Modal() {
    ...
    const [newTaskInput, setNewTaskInput, image, setImage, addTask, newTaskType] =
        useBoardStore(state => [state.newTaskInput, state.setNewTaskInput, state.image, state.setImage, state.addtask, state.newTaskType])
                                ...
                                <div className='mt-4'>
                                    <button
                                        ...
                                        className='
                                                    ...
                                                    focus-visible:ring-blue-500 focus-visible:ring-offset-2 disabled:bg-gray-100 disabled:text-gray-200
